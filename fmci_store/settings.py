"""
Django settings for fmci_store project.
...
ALLOWED_HOSTS = ['8000-brianach-fmcistore-as13qaxm2bk.ws-eu107.gitpod.io',
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'fmci-store'
...
if 'DEVELOPMENT' in os.environ:
    ...
    EMAIL_HOST_PASS = os.environ.get('EMAIL_HOST_USER')
    EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_PASS')
    DEFAULT_FROM_EMAILR = os.environ.get('EMAIL_HOST_USER')
